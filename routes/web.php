...
//prueba de combos
Route::get('/pais', 'EstadosController@pais')->name('pais.index');
Route::get('/estados/{pais}', 'EstadosController@estados')->name('estados');
Route::get('/colonias/{estados}', 'EstadosController@colonias')->name('colonias');
