            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Combos Dependientes
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select v-model="pais" name="pais" class="form-control" @change="loadEstados">
                                        <option value="">Selecciona un Pais</option>
                                        <option v-for="pai in paises" :value="pai.id"> {{ pai.nombre_pais }} </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select v-model="estado" name="estados" class="form-control" @change="loadColonias">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="email-input">Colonia</label>
                                    <div class="col-md-9">
                                        <select v-model="colonia"  class="form-control" >
                                        <!-- ojo con los v-modal y las funciones son super importantes -->
                                        <option value="">Selecciona una Colonia</option>
                                        <option v-for="col in colonias" :value="col.id"> {{ col.nombre_col }} </option>
                                        </select>
                                    </div>
                                </div>
...
<script>
    export default {
        ...
        mounted() {
            ...
            this.loadPaises(); //para el combo estados
        }
    }
</script>
