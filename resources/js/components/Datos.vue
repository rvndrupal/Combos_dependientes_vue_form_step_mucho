                        ...
                        <section v-if="paso == 1">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" v-model="nom" aria-describedby="emailHelp" placeholder="Nombre">
                                     <span v-for="e in errores" class="errores">{{ e }}</span>
                                    <span v-if="errorSer.ap" class="text-error">{{ errorSer.nom[0] }}</span>
                                </div>

                                <!-- <label for="img">Foto *</label>
                                <input type="file" class="form-control" v-model="img"> -->
